...
At the core (pun intended) of the ESP32 runs ESPHome firmware generated by the following configuration:
...
When combined with the [radar visualization](#radar-visualization) these cards help to easily set up the zones in your space. These are examples for three zones, support for more can be added in [Multisensor ESPHome yaml configuration](#esphome).
